      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            ...
            that bridge the gap between science and technology. Driven by curiosity
            and creativity, I strive to make a difference in the world of technology
            and biology, pushing the boundaries of what is possible.
          </p>
